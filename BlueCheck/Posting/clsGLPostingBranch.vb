Option Strict Off
Option Explicit On
Friend Class clsGLPostingBranch
	
    Public BranchCode As String
	Private sParty As New Collection
	
	Public Sub Add(ByRef Item As clsGLPostingParty, Optional ByRef key As Object = Nothing)
    ...
    Public Function Item(ByRef PartyCode As String) As clsGLPostingParty
        On Error Resume Next
        Item = sParty.Item(GenrateKeyParty(PartyCode))
    End Function
	
	Public Function ItemIndex(ByRef Index As Integer) As clsGLPostingParty
    ...
    Public Function AddParty(ByRef PartyCode As String) As clsGLPostingParty

        Dim p As New clsGLPostingParty
